...
<form name="tx_editor_form" id="tx_editor_form" action="modify.do" method="post" accept-charset="utf-8"> 
	...
	<table width="100%">
		...
		<tr> 
			<td><p>제목</p></td>
			<td><p><input size="100%" type="text" id="title" name="title" value="<%=dto.getTitle()%>" /></p></td>
		</tr> 
		<tr> 
			<td>내용</td> 
			<td id="editorTd" >
...
<script type="text/javascript" >
	Editor.modify({"content":'<%=dto.getContent()%>'});
</script>
